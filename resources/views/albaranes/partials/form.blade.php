...
<section class="albaran-form-ui" data-albaran-form data-form-mode="create" data-pedido-mode="0" data-pedido-bolsa="{{ $pedidoBolsa ? '1' : '0' }}" data-initial-lineas="{{ e($lineasJsonInicial) }}">
